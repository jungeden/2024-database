            ...
            <div class='qnalistbox'>
                ...
                <div class='listbox search' >
                    ...
                    <div class='board'>
                        ...
                        $getboard = mysqli_query($con, "SELECT id, userid, topic, wdate, hit, parentid, issecret, space FROM customerboard WHERE topic LIKE '%$searchname%' ORDER BY num DESC");
                        echo("
                    <div class='board'>");
