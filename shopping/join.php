...
$insertSql = "INSERT INTO user (userid, userpasswd, userpasswdcheck, username, userphone, useremail, userbirth, userjoindate, zipcode, address1, address2) VALUES ('$_GET[userid]', '$_POST[userpasswd]', '$_POST[userpasswdcheck]', '$_POST[username]', '$_POST[userphone]', '$_POST[useremail]', '$_POST[userbirth]', '$userjoindate', '$_POST[zipcode]','$_POST[address1]','$_POST[address2]')";
