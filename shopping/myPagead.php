                ...
                <div class='userinfobox'>
                    <form method='post' action='managead.php' enctype='multipart/form-data'>
                        <div class='productphoto de'>
                            ...
                            <input class='file' type='file' name=\"adfile[]\" id='adfile'  multiple accept='image/*'   onchange='previewImage(event, false)'>
                            ...
                            foreach ($adfiles as $adfile) {
                                $adfile = trim($adfile); 
                                echo("
                                    <img class='preview' style='margin:5px; width:500px; height:auto;'src='./ad/$adfile' alt='Product Image'>
                                    <script>
                                        console.log('$adfile');
                                    </script>
                                ");
