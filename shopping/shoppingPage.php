...
$sql = "SELECT * FROM product ORDER BY hit DESC";
...
if ($total == 0) {
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        <div class='products'>
            ...
            if ($likeStatus == 0) {
                echo "
                <button class='heart1' style='background-color:rgb(28,28,28);' 
                    onclick='window.location=\"like.php?islike=0&pcode=$code&page=shopping\"'>
                </button>";
            } else {
                echo "
                <button class='heart1' style='background-color:rgb(230,230,230);' 
    ...
    echo "</div>
            ...
            //         <a class='filter ho'>categories</a>
            //         <input style='display:none;' id='categoriescheck' name='categoriescheck' >

            //         <div class='filteroption'>
            //             <div class='check' id='outer' onclick=\"toggleFixed(this)\"></div>
            //             <a class='ho' >겉옷</a>
            //         </div>
            //         <div class='filteroption'>
            //             <div class='check' id='shirt' onclick=\"toggleFixed(this)\"></div>
            //             <a class='ho'>셔츠</a>
            //         </div>
            //         <div class='filteroption'>
            //             <div class='check' id='skirt' onclick=\"toggleFixed(this)\"></div>
            //             <a class='ho'>치마</a>
            //         </div>
            //         <div class='filteroption'>
            //             <div class='check' id='pants' onclick=\"toggleFixed(this)\"></div>
            //             <a class='ho'>바지</a>
            //         </div>
            //         <div class='filteroption'>
            //             <div class='check' id='other' onclick=\"toggleFixed(this)\"></div>
            //             <a class='ho'>기타</a>
            //         </div>
            //         <div class='line'>
            //         </div>");
