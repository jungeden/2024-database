...
<body>
    <div class='container'>
        ...
        <div class='middle login'>
            <div class='label'>
                <form method='post' action='joinPage.php'>
                    <div class='gray' style='margin-left:10px; font-size:20px;'>약관 동의</div>
                    <div class='line'> </div>  
                    <div class='agtextbox'>
                        <div class='agtext' >
                            <div class='gray'>이용약관 동의</div>&nbsp;
                            <div class='red'>(필수)</div>
                        </div>
                        <input type='hidden'  name='policy1'  id='policy1' value='n'>
                        <div class='check po1' id='y' onclick=\"toggleFixed(this,'policy1')\"></div>
                        
                    </div>
                    <div class='input policybox' style='color:rgb(125,118,101); white-space: pre-wrap; word-wrap: break-word;' >
...
② “몰”과 이용자 간에 제기된 전자상거래 소송에는 한국법을 적용합니다.
                    ...
                    <div class='agtextbox'>
                        <div class='agtext' >
                            <div class='gray'>개인정보 수집 및 이용 동의</div>&nbsp;
                            <div class='red'>(필수)</div>
                        </div>
                        <input type='hidden'  name='policy2'  id='policy2' value='n'>
                        <div class='check po2' id='y' onclick=\"toggleFixed(this,'policy2')\"></div>
...
2) 시행일자 : 2018년 05월 01일 
                    ...
                    <div class='line'> </div>  
                     <div class='agtextbox'>
                        <div class='agtext' >
                            <div class='gray'>전체 동의</div>&nbsp;
                        </div>
                        <input type='hidden'  name='policy12'  id='policy12' value='n'>
                        <div class='check' id='y' onclick=\"toggleFixed(this,'policy12');\"></div>
...
function toggleFixed(element, categories) {
    ...
    if (categories=='policy12') {
        const policy1 = document.getElementById('policy1');
        const policy2 = document.getElementById('policy2');
        if (!isFixed) {
            if (policy1) {
                const po1Element = document.getElementsByClassName('po1')[0];
                if (po1Element) {
                    po1Element.classList.add('fixed');
                    policy1.value = 'y';
                    console.log(policy1.id, ':', policy1.value);
                }
            }
            
            if (policy2) {
                const po2Element = document.getElementsByClassName('po2')[0];
                if (po2Element) {
                    po2Element.classList.add('fixed');
                    policy2.value = 'y';
                    console.log(policy2.id, ':', policy2.value);
                }
            }
            ...
            if (policy1) {
                const po1Element = document.getElementsByClassName('po1')[0];
                if (po1Element) {
                    po1Element.classList.remove('fixed');
                    policy1.value = 'n';
                    console.log(policy1.id, ':', policy1.value);
                }
            }
            ...
            if (policy2) {
                const po2Element = document.getElementsByClassName('po2')[0];
                if (po2Element) {
                    po2Element.classList.remove('fixed');
                    policy2.value = 'n';
                    console.log(policy2.id, ':', policy2.value);
                }
            }
     ...
     const Element = document.getElementsByClassName('check')[2];
        if (isFixed) {
            Element.classList.remove('fixed'); 
