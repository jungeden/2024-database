...
<body>
    <div class='container'>
        ...
        <div class='middle'>
            ...
            <div class='box'>
                <form method='post' action='finduserpasswd.php'>
                    <div class='inputuseridbox'>
                        아이디
                        <input class='input' type='text' name='userid' placeholder='아이디를 입력해주세요'>
                    </div> 
                    <div class='inputbox'>
                        전화번호로 찾기
                        <input class='input' type='text' name='phone' placeholder='전화번호를 입력해주세요'>
                        이메일로 찾기
                        <input class='input' type='text' name='email' placeholder='이메일을 입력해주세요'>
                    </div>
