        ...
        <div class='middle'>
            ...
            <div class='right middle' id='rightmiddle'>
                <div class='infotbox'>
                    ...
                    <div class='pointbox'>
                    <div class='po'>
                        <a class='text infolabeltext'>포인트</a>
                        <a class='text userinfotext' style='font-size:50px; color:rgb(255,197,90); background-color:white;'>$pointformat<a></div>
                        <div class='pol'>");
                $getpoint = mysqli_query($con,"SELECT * FROM pointlist WHERE userid='$userid'");

                while($prow=mysqli_fetch_assoc($getpoint)) {
                    $pmpoint = $prow['pmpoint'];
                    $pmpoint = number_format($pmpoint);
                    $pm = $prow['pm'];
                    $udate = substr($prow['udate'],0,10);

                    $resultpoint = $prow['resultpoint'];
                    echo("
                    <div class='plist'>
                        <div style='color:rgb(125,118,101);'>
                            $udate
                        </div>
                        <div>
                            <div class='ptext'>
                            ...
                            <a style='color:rgb(255,197,90); font-size:20px;'>$resultpoint</a>
                        </div>
                    </div>
