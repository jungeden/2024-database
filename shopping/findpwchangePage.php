...
<body>
    <div class='container'>
        ...
        <div class='line'></div>
        <div class='middle'>
            <div style='color:rgb(255,197,90); font-size:20px;'>비밀번호 변경</div>
            <div class='box'>
                <form method='post' action='findpwchange.php?userid=$userid'>
                    <div class='inputbox'>
                        비밀번호
                        <input class='input' type='password' name='userpasswd' placeholder='비밀번호를 입력해주세요.'>
                        비밀번호 확인
                        <input class='input' type='password' name='userpasswdcheck' placeholder='비밀번호를 입력해주세요.'>
                    </div>
