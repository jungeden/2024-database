...
<body>
    <div class='container'>
        ...
        <div class='line'></div>
        <div class='middle'>
            <div style='color:rgb(255,197,90); font-size:20px;'>비밀번호 찾기</div>
            <div class='box' style='margin-top:20px;' >
                <form method='post' action='findpwemailcheck.php?userid=$userid'>
                    <input class='button' type='submit' value='인증번호 전송'>
                </form>
                <form method='post' action='findpwcode.php?userid=$userid'>
                    <div class='inputuseridbox' style='margin-top:20px;' >
                        인증번호
                        <input class='input' type='text' name='usercheckcode' placeholder='인증번호를 입력해주세요'>
                        <input type='hidden' name='checkcode' value='$checkcode'>
                    </div> 
                    <input class='button' style='margin-top:0px;' type='submit' value='완료'>
                </form>
            </div>
        </div>
