    ...
    <div class='container'>
        ...
        <div class='middle'>
            ...
            <div class='qnalistbox'>
                <div class='qnainputbutton'>
                    <button class='button' style='margin:50px;' onclick='window.location.href=\"customerinputPage.php\"'>문의하기</button> 
                </div>");
                 $selectclassname = '상품';
                 $selectclass = 'product';
                 echo("
                <div class='listbox' id='$selectclass'>
                    <div class='listlabel' >
                        <div>$selectclassname</div>");
                        echo("
                        <a class='test' id='$selectclass down' onclick=\"openToggle('$selectclass down', '$selectclass')\">
                            <svg xmlns='http://www.w3.org/2000/svg' height='30px' viewBox='0 -960 960 960' width='30px' ><path class='icon'  d='M480-344 240-584l56-56 184 184 184-184 56 56-240 240Z'/></svg>
                        </a>
                        ");
                        echo("
                    </div>
");
                    ...
                    <div class='board'>");
                        ...
                        <div class='boardlist'>
                            ...
                            <div style='width:5%; color:rgb(125,118,101); text-align:end;'>$hit</div>
                            <a class='sec'>
                                <svg xmlns='http://www.w3.org/2000/svg' height='20px' viewBox='0 -960 960 960' width='20px' fill='#7d7665'><path d='M240-80q-33 0-56.5-23.5T160-160v-400q0-33 23.5-56.5T240-640h40v-80q0-83 58.5-141.5T480-920q83 0 141.5 58.5T680-720v80h40q33 0 56.5 23.5T800-560v400q0 33-23.5 56.5T720-80H240Zm0-80h480v-400H240v400Zm240-120q33 0 56.5-23.5T560-360q0-33-23.5-56.5T480-440q-33 0-56.5 23.5T400-360q0 33 23.5 56.5T480-280ZM360-640h240v-80q0-50-35-85t-85-35q-50 0-85 35t-35 85v80ZM240-160v-400 400Z'/></svg>
                            </a>
                        </div> 
                        ");
                            } else {
...
<?
    ...
    <script>
        function openToggle(elementId, categoryId) {
    const element = document.getElementById(elementId);
    const category = document.getElementById(categoryId);

    const isDown = element.classList.contains('changedown');

    if (isDown) {
        element.classList.remove('changedown');
        category.classList.remove('boxopen');
    } else {
        element.classList.add('changedown');
        category.classList.add('boxopen');
    }
}
