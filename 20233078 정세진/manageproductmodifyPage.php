                ...
                <div class='left middle'>
                    <div class='productphoto'>
                       ...
                       <a class='phototext' style='margin-top:35px;'>사진추가</a>
                        <input class='file' type='file' name='userfile' accept='image/*' onchange='previewImage(event, true)' value='$userfile'>
                         <div class='preview-container'>
                          <img alt='Image Preview' class='preview' src='./photo/$userfile'>
                         </div> 
                       
                    </div>
                     <div class='productphoto de'>
                        <a class='phototext' >
                            <svg xmlns='http://www.w3.org/2000/svg' height='30px' viewBox='0 -960 960 960' width='30px' fill='#C8C8C8'>
                                <path id='input' d='M460-460H240v-40h220v-220h40v220h220v40H500v220h-40v-220Z'/>
                            </svg>
                        </a>
                        <a class='phototext'  style='margin-top:35px;'>사진추가</a>
                        <input class='file' type='file' name=\"detailuserfile[]\" id='detailuserfile'  multiple accept='image/*'   onchange='previewImage(event, false)' value=$detailfile>

                        <div class='preview-container'>");
             
                        $detailfiles = explode(',', $detailfile); 
                        
                        foreach ($detailfiles as $detailfile) {
                            // $detailfile = trim($detailfile); // 공백 제거 (필요시)
                            echo("
                                <img class='preview' style='margin:5px; width:100px; height:100px;'src='./uploads/$detailfile' alt='Product Image'>
                                <script>
                 ...
                 <div class='center middle'>
                    <div class='productinfo'>
                        ...
                        echo("
                            <input name='size' id='size' style='display:none;' value='$size'>
                            ...
                            foreach ($sizes as $size) {
                                ...
                                <script>
                                console.log('$size');
                                    document.getElementById('$size').classList.add('fixed');
                            ...
                            foreach ($colors as $color) {
                                echo("
                                <script>
                                    document.getElementById('$color').classList.add('fixed');
