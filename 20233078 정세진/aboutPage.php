...
<body>
    <div class='container'>
        ...
        <div class='line'></div>
        <div class='middle'>
            <div class='zaumtitlebox'>
                <div class='zaumtitle z'>
                    Z
                </div>
                <div class='zaumtitle a'>
                    A
                </div>
                <div class='zaumtitle u'>
                    U
                </div>
                <div class='zaumtitle m'>
                    M
                </div>
            </div>
            
            <div class='texts'>
                자음은 다양한 옷을 판매하는 웹페이지 입니다.
            </div>
        ...
        <script>
            ...
            elements.forEach(element => {
                // 랜덤 위치
                const randomTop = Math.random() * (screenHeight - 50); // 요소 높이를 고려
                const randomLeft = Math.random() * (screenWidth - 50); // 요소 폭을 고려
