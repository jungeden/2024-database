            ...
            if($status==1){
                ...
                // $getorderlist=mysqli_query($con,"SELECT * FROM orderlist INNER JOIN product ON orderlist.pcode=product.code INNER JOIN receivers ON orderlist.userid=receivers.userid WHERE orderlist.userid='$userid'");
                 while($row=mysqli_fetch_assoc($getorderlist)) {
                    ...
                    $optionrow=mysqli_fetch_assoc($getoption);
                    $size=$optionrow['size'];
                ...
                <div class='productinfo'>
                    ...
                    if($status==3) {
                        $isreview = mysqli_query($con, "SELECT * FROM review WHERE userid='$userid' AND session='$session' AND pcode='$pcode' AND size='$size' AND color='$color'");
                        if(mysqli_num_rows($isreview)==0) {
                        echo(" 
                    <div class='reviewbuttonbox'>
                        <a href='reviewwritePage.php?pcode=$pcode&buydate=$buydate&size=$size&color=$color'>");
                ...
                if($status == 1) {
                    ...
                    echo("  
                <div class='total'>
                    <a style='font-size:13px; margin-top:10px;'>");
